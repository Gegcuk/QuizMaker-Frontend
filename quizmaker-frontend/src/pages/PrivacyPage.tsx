    ...
    <>
      ...
      <PageContainer title="Privacy Policy" showHeader subtitle="How we handle your data, in plain language">
        <article className="prose max-w-none text-theme-text-primary prose-headings:text-theme-text-primary prose-p:text-theme-text-secondary dark:prose-invert">
          <p className="text-sm text-theme-text-secondary">Last updated: 10 December 2025</p>
          ...
          <section className="mb-10">
            <h2>1. Who we are and when this policy applies</h2>
            <p>
          ...
          <section className="mb-10">
            ...
            <h3>3.1. Run your account and deliver the service (contract)</h3>
            <ul>
            ...
            <h3>3.2. Generate quizzes and feedback using AI (contract / legitimate interests)</h3>
            <ul>
            ...
            <h3>3.3. Keep the service secure and reliable (legitimate interests / legal obligations)</h3>
            <ul>
            ...
            <h3>3.4. Communicate with you (contract / legitimate interests / consent)</h3>
            <ul>
            ...
            <h3>3.5. Analyse and improve Quizzence (legitimate interests)</h3>
            <ul>
          ...
          <section className="mb-10">
            <h2>4. Cookies, analytics and similar technologies</h2>
          ...
          <section className="mb-10">
            <h2>5. AI and how your content is processed</h2>
          ...
          <section className="mb-10">
            <h2>6. Sharing your data and third-party providers</h2>
          ...
          <section className="mb-10">
            <h2>11. Students, teachers and children</h2>
            <ul>
              <li>
