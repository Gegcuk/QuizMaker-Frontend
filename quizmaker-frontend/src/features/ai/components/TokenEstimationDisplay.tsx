    ...
    return (
      <div className={`p-4 bg-theme-bg-secondary border border-theme-border-primary rounded-lg ${className}`}>
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-theme-text-secondary">Enter content (at least 300 characters) and select at least one question type to see token estimation</span>
        </div>
      </div>
    );
  }
