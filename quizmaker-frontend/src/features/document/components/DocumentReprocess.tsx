      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-3">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-theme-text-primary bg-theme-interactive-primary border border-transparent rounded-md hover:bg-theme-interactive-primary-hover focus:outline-none focus:ring-2 focus:ring-theme-interactive-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isReprocessing ? (
              <>
