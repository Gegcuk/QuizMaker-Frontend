...
const UserMenu: React.FC<UserMenuProps> = ({ className = '' }) => {
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      >
        {/* Avatar */}
        <div className="w-8 h-8 bg-theme-interactive-primary text-theme-text-primary rounded-full flex items-center justify-center text-sm font-medium">
          ...
          <div className="py-1" role="menu" aria-orientation="vertical">
            ...
            <div className="py-1">
              <Button
                ...
                className="!w-full !text-left !justify-start !px-4 !py-2 !text-sm !text-theme-text-secondary hover:!bg-theme-bg-secondary focus:!bg-theme-bg-secondary focus:outline-none transition-colors !rounded-none"
                role="menuitem"
                leftIcon={
            ...
            {error && (
              <div className="border-t border-theme-border-primary">
                <Alert type="error" className="!rounded-none !border-0 !border-b !border-theme-border-primary text-sm">
                  {error}
                </Alert>
              </div>
            )}
            ...
            <div className="py-1 border-t border-theme-border-primary">
              <Button
                ...
                disabled={isLoading}
                loading={isLoading}
                className="!w-full !text-left !justify-start !px-4 !py-2 !text-sm !text-theme-interactive-danger hover:!bg-theme-bg-danger focus:!bg-theme-bg-danger focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed transition-colors !rounded-none"
                role="menuitem"
                leftIcon={
                  !isLoading && (
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
