...
const UserStats: React.FC<UserStatsProps> = ({
  ...
  if (!stats) {
    return (
      <div className={`bg-theme-bg-warning border border-theme-border-warning rounded-md p-4 ${className}`}>
        <div className="flex">
          <div className="flex-shrink-0">
          ...
          <div className="bg-theme-bg-info p-4 rounded-lg">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-2xl font-bold text-theme-text-primary">{stats.completedQuizzes}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-theme-bg-success p-4 rounded-lg">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-2xl font-bold text-theme-text-primary">{stats.averageScore}%</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-theme-bg-primary p-4 rounded-lg">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-2xl font-bold text-theme-text-primary">{formatTime(stats.totalTimeSpent)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-theme-bg-warning p-4 rounded-lg">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-2xl font-bold text-theme-text-primary">#{stats.rank}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {stats.achievements.map((achievement) => (
              <div
                key={achievement.id}
                className="bg-gradient-to-br from-yellow-50 to-orange-50 p-4 rounded-lg border border-theme-border-warning"
              >
