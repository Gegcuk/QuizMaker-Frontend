      ...
      <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 ${className}`}>
        {Array.from({ length: 8 }).map((_, index) => (
          <div key={index} className="bg-theme-bg-primary rounded-lg shadow-md animate-pulse">
            ...
            <div className="p-6">
              <div className="h-4 bg-theme-bg-tertiary rounded mb-2"></div>
              <div className="h-4 bg-theme-bg-tertiary rounded w-2/3 mb-4"></div>
              <div className="h-8 bg-theme-bg-tertiary rounded"></div>
            </div>
          </div>
        ))}
      </div>
