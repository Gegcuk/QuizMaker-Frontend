  ...
  return (
    <>
      ...
      <button
        ...
        className={`inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-theme-bg-overlay hover:bg-theme-bg-overlay focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-interactive-success ${className}`}
      >
