...
const providerConfig: Record<OAuthProvider, {
  name: string;
  // Note: Provider buttons use brand colors (not theme colors) for brand recognition
  // This is acceptable as OAuth buttons should be recognizable across all themes
  lightBg: string;   // Background in light mode
  darkBg: string;    // Background in dark mode
  lightText: string; // Text in light mode
  darkText: string;  // Text in dark mode
  ...
  GOOGLE: {
    ...
    lightText: 'text-neutral-700 dark:text-neutral-200',
  ...
  GITHUB: {
    name: 'GitHub',
    lightBg: 'bg-neutral-900 dark:bg-neutral-800',
    darkBg: 'dark:bg-neutral-800',
  ...
  FACEBOOK: {
    name: 'Facebook',
    lightBg: 'bg-[#1877f2] dark:bg-[#1877f2]',
    darkBg: 'dark:bg-[#1877f2]',
    lightText: 'text-white',
    darkText: 'text-white',
    icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  MICROSOFT: {
    name: 'Microsoft',
    lightBg: 'bg-neutral-800 dark:bg-neutral-700',
