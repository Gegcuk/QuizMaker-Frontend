  ...
  theme: {
    extend: {
      colors: {
        ...
        'theme-matching-pair-1-bg': 'var(--color-matching-pair-1-bg)',
        'theme-matching-pair-1-border': 'var(--color-matching-pair-1-border)',
        'theme-matching-pair-1-badge': 'var(--color-matching-pair-1-badge)',
        'theme-matching-pair-2-bg': 'var(--color-matching-pair-2-bg)',
        'theme-matching-pair-2-border': 'var(--color-matching-pair-2-border)',
        'theme-matching-pair-2-badge': 'var(--color-matching-pair-2-badge)',
        'theme-matching-pair-3-bg': 'var(--color-matching-pair-3-bg)',
        'theme-matching-pair-3-border': 'var(--color-matching-pair-3-border)',
        'theme-matching-pair-3-badge': 'var(--color-matching-pair-3-badge)',
        'theme-matching-pair-4-bg': 'var(--color-matching-pair-4-bg)',
        'theme-matching-pair-4-border': 'var(--color-matching-pair-4-border)',
        'theme-matching-pair-4-badge': 'var(--color-matching-pair-4-badge)',
